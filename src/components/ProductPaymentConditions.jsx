  ...
  return (
    <>
      <ul className="flex flex-col gap-3 list-disc py-5 pl-10 pr-5">
        ...
        <li>La <strong>vigencia</strong> de este presupuesto es de <strong>15 días</strong> a partir de la fecha de recepción del anticipo</li>
        <li>Con la <strong>entrega</strong> de la batería <strong>empieza la garantía</strong> con sus especificaciones</li>
        <li>Este presupuesto <strong>no incluye</strong> ningún trabajo y/o producto no especificado en él</li>
      </ul>
    </>
  );
}
